...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Pontos de Saque: %" +saquePercentual);
        System.out.println("Pontos de Bloqueio: %" +bloqueioPercentual);
        System.out.println("Pontos de Ataque: %"+ ataquePercentual);
